...
export const INITIAL_PRODUCTS: InvestmentProduct[] = [
  {
    ...
    get dailyYieldAmount() { return +(this.cost * this.dailyYieldPercent / 100).toFixed(2); }, // R$ 10.00/dia
    efficiency: '94.2%',
    hashrate: '450 MH/s',
...
export const COMMISSIONS = {
  level1: 0.18, // 18% do valor do investimento do convidado
  level2: 0.03, // 3% do nível 2
